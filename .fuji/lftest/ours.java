<<<<<<< leaf-server/src/minecraft/java/net/minecraft/world/item/Items.java
...
public class Items {
    ...
    public static final Item ACACIA_SHELF = registerBlock(
        Blocks.ACACIA_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
    );
    public static final Item BAMBOO_SHELF = registerBlock(
        Blocks.BAMBOO_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
    );
    public static final Item BIRCH_SHELF = registerBlock(
        Blocks.BIRCH_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
    );
    public static final Item CHERRY_SHELF = registerBlock(
        Blocks.CHERRY_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
    );
    public static final Item CRIMSON_SHELF = registerBlock(
        Blocks.CRIMSON_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
    );
    public static final Item DARK_OAK_SHELF = registerBlock(
        Blocks.DARK_OAK_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
    );
    public static final Item JUNGLE_SHELF = registerBlock(
        Blocks.JUNGLE_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
    );
    public static final Item MANGROVE_SHELF = registerBlock(
        Blocks.MANGROVE_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
    );
    public static final Item OAK_SHELF = registerBlock(
        Blocks.OAK_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
    );
    public static final Item PALE_OAK_SHELF = registerBlock(
        Blocks.PALE_OAK_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
    );
    public static final Item SPRUCE_SHELF = registerBlock(
        Blocks.SPRUCE_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
    );
    public static final Item WARPED_SHELF = registerBlock(
        Blocks.WARPED_SHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
    );
    ...
    public static final Item TORCH = registerBlock(
        Blocks.TORCH, (block, properties) -> new StandingAndWallBlockItem(block, Blocks.WALL_TORCH, Direction.DOWN, properties)
    );
    ...
    public static final Item CARVED_PUMPKIN = registerBlock(
        ...
        properties -> Waypoint.addHideAttribute(properties)
            .component(
    ...
    public static final Item SOUL_TORCH = registerBlock(
        Blocks.SOUL_TORCH, (block, properties) -> new StandingAndWallBlockItem(block, Blocks.SOUL_WALL_TORCH, Direction.DOWN, properties)
    );
    public static final Item COPPER_TORCH = registerBlock(
        Blocks.COPPER_TORCH, (block, properties) -> new StandingAndWallBlockItem(block, Blocks.COPPER_WALL_TORCH, Direction.DOWN, properties)
    );
    ...
    public static final Item LIGHT = registerBlock(
        Blocks.LIGHT,
        properties -> properties.rarity(Rarity.EPIC).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(LightBlock.LEVEL, 15))
    );
    public static final Item HAY_BLOCK = registerBlock(Blocks.HAY_BLOCK);
    public static final Item WHITE_CARPET = registerBlock(
        Blocks.WHITE_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.WHITE))
    );
    public static final Item ORANGE_CARPET = registerBlock(
        Blocks.ORANGE_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.ORANGE))
    );
    public static final Item MAGENTA_CARPET = registerBlock(
        Blocks.MAGENTA_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.MAGENTA))
    );
    public static final Item LIGHT_BLUE_CARPET = registerBlock(
        Blocks.LIGHT_BLUE_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIGHT_BLUE))
    );
    public static final Item YELLOW_CARPET = registerBlock(
        Blocks.YELLOW_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.YELLOW))
    );
    public static final Item LIME_CARPET = registerBlock(
        Blocks.LIME_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIME))
    );
    public static final Item PINK_CARPET = registerBlock(
        Blocks.PINK_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.PINK))
    );
    public static final Item GRAY_CARPET = registerBlock(
        Blocks.GRAY_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GRAY))
    );
    public static final Item LIGHT_GRAY_CARPET = registerBlock(
        Blocks.LIGHT_GRAY_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIGHT_GRAY))
    );
    public static final Item CYAN_CARPET = registerBlock(
        Blocks.CYAN_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.CYAN))
    );
    public static final Item PURPLE_CARPET = registerBlock(
        Blocks.PURPLE_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.PURPLE))
    );
    public static final Item BLUE_CARPET = registerBlock(
        Blocks.BLUE_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BLUE))
    );
    public static final Item BROWN_CARPET = registerBlock(
        Blocks.BROWN_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BROWN))
    );
    public static final Item GREEN_CARPET = registerBlock(
        Blocks.GREEN_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GREEN))
    );
    public static final Item RED_CARPET = registerBlock(
        Blocks.RED_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.RED))
    );
    public static final Item BLACK_CARPET = registerBlock(
        Blocks.BLACK_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BLACK))
    );
    ...
    public static final Item TUBE_CORAL_FAN = registerBlock(
        Blocks.TUBE_CORAL_FAN, (block, properties) -> new StandingAndWallBlockItem(block, Blocks.TUBE_CORAL_WALL_FAN, Direction.DOWN, properties)
    );
    public static final Item BRAIN_CORAL_FAN = registerBlock(
        Blocks.BRAIN_CORAL_FAN, (block, properties) -> new StandingAndWallBlockItem(block, Blocks.BRAIN_CORAL_WALL_FAN, Direction.DOWN, properties)
    );
    public static final Item BUBBLE_CORAL_FAN = registerBlock(
        Blocks.BUBBLE_CORAL_FAN, (block, properties) -> new StandingAndWallBlockItem(block, Blocks.BUBBLE_CORAL_WALL_FAN, Direction.DOWN, properties)
    );
    public static final Item FIRE_CORAL_FAN = registerBlock(
        Blocks.FIRE_CORAL_FAN, (block, properties) -> new StandingAndWallBlockItem(block, Blocks.FIRE_CORAL_WALL_FAN, Direction.DOWN, properties)
    );
    public static final Item HORN_CORAL_FAN = registerBlock(
        Blocks.HORN_CORAL_FAN, (block, properties) -> new StandingAndWallBlockItem(block, Blocks.HORN_CORAL_WALL_FAN, Direction.DOWN, properties)
    );
    public static final Item DEAD_TUBE_CORAL_FAN = registerBlock(
        Blocks.DEAD_TUBE_CORAL_FAN, (block, properties) -> new StandingAndWallBlockItem(block, Blocks.DEAD_TUBE_CORAL_WALL_FAN, Direction.DOWN, properties)
    );
    public static final Item DEAD_BRAIN_CORAL_FAN = registerBlock(
        Blocks.DEAD_BRAIN_CORAL_FAN, (block, properties) -> new StandingAndWallBlockItem(block, Blocks.DEAD_BRAIN_CORAL_WALL_FAN, Direction.DOWN, properties)
    );
    public static final Item DEAD_BUBBLE_CORAL_FAN = registerBlock(
        Blocks.DEAD_BUBBLE_CORAL_FAN, (block, properties) -> new StandingAndWallBlockItem(block, Blocks.DEAD_BUBBLE_CORAL_WALL_FAN, Direction.DOWN, properties)
    );
    public static final Item DEAD_FIRE_CORAL_FAN = registerBlock(
        Blocks.DEAD_FIRE_CORAL_FAN, (block, properties) -> new StandingAndWallBlockItem(block, Blocks.DEAD_FIRE_CORAL_WALL_FAN, Direction.DOWN, properties)
    );
    public static final Item DEAD_HORN_CORAL_FAN = registerBlock(
        Blocks.DEAD_HORN_CORAL_FAN, (block, properties) -> new StandingAndWallBlockItem(block, Blocks.DEAD_HORN_CORAL_WALL_FAN, Direction.DOWN, properties)
    );
    ...
    public static final Item REDSTONE_TORCH = registerBlock(
        Blocks.REDSTONE_TORCH, (block, properties) -> new StandingAndWallBlockItem(block, Blocks.REDSTONE_WALL_TORCH, Direction.DOWN, properties)
    );
    ...
    public static final Item DISPENSER = registerBlock(
        Blocks.DISPENSER, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY)
    );
    ...
    public static final Item OAK_HANGING_SIGN = registerBlock(
        ...
        (block, properties) -> new HangingSignItem(block, Blocks.OAK_WALL_HANGING_SIGN, properties),
    ...
    public static final Item BIRCH_HANGING_SIGN = registerBlock(
        ...
        (block, properties) -> new HangingSignItem(block, Blocks.BIRCH_WALL_HANGING_SIGN, properties),
        new Item.Properties().stacksTo(16)
    );
    ...
    public static Item registerBlock(Block block, UnaryOperator<Item.Properties> propertiesModifier) {
        return registerBlock(block, (block1, properties) -> new BlockItem(block1, propertiesModifier.apply(properties)));
    }

    public static Item registerBlock(Block block, Block... others) {
        Item item = registerBlock(block);

        for (Block block1 : others) {
    ...
    public static Item registerBlock(Block block, BiFunction<Block, Item.Properties, Item> factory, Item.Properties properties) {
        return registerItem(
            blockIdToItemId(block.builtInRegistryHolder().key()), properties1 -> factory.apply(block, properties1), properties.useBlockDescriptionPrefix()
        );
    }
...
||||||| D:/BadgersMC-Dev/Sakura-donor/.gradle/caches/paperweight/upstreams/server-work/paper/src/minecraft/java/net/minecraft/world/item/Items.java
package net.minecraft.world.item;
...
>>>>>>> D:/BadgersMC-Dev/Sakura-donor/sakura-server/src/minecraft/java/net/minecraft/world/item/Items.java
