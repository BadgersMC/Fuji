 ...
 * <p>
 * Behavior spec reverse-engineered from Tequila ({@code tntHeightNerfOnlyWithHorizontalVelocity});
 * this is a clean-room reimplementation against Fuji's own entity ticks. Defaults off (stock Paper
 * behavior); only takes effect when the corresponding Paper height-nerf is also set.
 */
